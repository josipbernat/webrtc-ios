...
#import "CSPeerConnectionHandler.h"
...
@interface CSPeerConnectionHandler () <ICEServerDelegate, GAEMessageHandler, RTCSessionDescriptonDelegate, RTCPeerConnectionDelegate>
...
@implementation CSPeerConnectionHandler

#pragma mark - Shared Instance

+ (instancetype)sharedInstance {

    static CSPeerConnectionHandler *instance = nil;
    ...
    if (self = [super init]) {
        ...
        [[NSNotificationCenter defaultCenter] addObserverForName:UIApplicationWillResignActiveNotification
                                                      ...
                                                      usingBlock:^(NSNotification *note) {
                                                          ...
                                                          __strong CSPeerConnectionHandler *strongThis = this;
